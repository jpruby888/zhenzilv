...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.3.3",\n        "192.168.47.1",\n        "192.168.126.1",\n        "172.23.0.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "D:/Program Files/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"zhenzilv","spaceId":"cb838425-d541-4685-9459-b1289a713225","clientSecret":"0daFNJe75yHJu0q/vO0byA==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__93056A1";
} catch (e2) {
